...
const users = [
  ["iris@schakel-nijmegen.nl", "Iris Venderbosch", Role.VERWIJZER, "Huisartsenpraktijk De Schakel"],
  ...
  ["andrea@bindkracht10.nl", "Andrea Olfen", Role.SOCIAAL, "Bindkracht10"],
  ["margot@buurtteamsvolwassenen.nl", "Margot van Delft", Role.SOCIAAL, "Buurtteams Volwassenen"],
...
const resources = [
  ...
  },
  {
    ...
    contactEmail: "info@bindkracht10.nl",
    contactPhone: "024-9876543",
    address: "Zwanenveld 90-12, Nijmegen",
    stadsdeel: "Dukenburg",
    wijk: "Zwanenveld",
    targetGroup: "Volwassen inwoners",
    costs: "Gratis",
  ...
  {
    name: "Wandelgroep Dukenburg",
    description: "Laagdrempelige wekelijkse wandelgroep voor ontmoeting en beweging.",
    category: "Bewegen",
    organization: "Dukenburg Beweegt",
    contactPhone: "06-20000001",
    address: "Malvert, Nijmegen",
    stadsdeel: "Dukenburg",
    wijk: "Malvert",
